...
import {IEspressoLegacySGXTEEVerifier} from "./interface/IEspressoLegacySGXTEEVerifier.sol";
 ...
 */
contract EspressoLegacySGXTEEVerifier is
    IEspressoLegacySGXTEEVerifier,
    Ownable2Step
{
    ...
    */
    function verify(
        ...
        if (
            localReport.mrEnclave != mrEnclave ||
            localReport.mrSigner != mrSigner
        ) {
